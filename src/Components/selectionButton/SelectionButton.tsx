...
const SelectionButton = memo(function SelectionButton({clickWeatherSelectionBtn}: ComponentProps): React.JSX.Element {
    ...
    const btnPress = useCallback((event: React.MouseEvent<HTMLButtonElement>) => {
        setShowFiveDays(showFiveDays => !showFiveDays)
